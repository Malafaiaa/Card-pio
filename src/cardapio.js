...
import picadinhoCarneImg from './assets/pratos/picadinhoCarne.avif';
...
const picadinhoCarne = {
  nome: 'Picadinho de Carne',
  preco: 'R$ 35,00',
  imagem: picadinhoCarneImg,
  descricao: 'Picadinho perfeito com batata frita e arroz',
};
